...
export default function SignInBtn() {
  return (
    <div className=" border border-indigo-300 p-3 rounded-lg bg-indigo-100 max-w-xl mx-auto grid gap-4 mt-10">
      <button
        onClick={() => {
          signIn('google')
        }}
        className="flex items-center justify-center gap-4 rounded-2xl pl-3 mb-4"
      >
